...
description: Use this skill for looking up database schemas, tables, columns, sample rows, and query examples from configured local documentation or database references. Follow its source guidance and avoid exposing secrets.
metadata:
